...
print("==> config/settings.py chargé")
...
SECRET_KEY = 'django-insecure-vh25vyalj3r254oxtth_av=l706fk$b0v9mdazqa5!*^ydlth@'
...
print("Settings loaded, ROOT_URLCONF =", ROOT_URLCONF)
